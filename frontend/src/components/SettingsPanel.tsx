...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({ model, setModel, format, setFormat }) => {
    return (
        <div className="bg-obsidian-surface/60 backdrop-blur-md border border-white/10 rounded-lg p-6 mb-8 mt-8 shadow-[0_20px_50px_rgba(0,0,0,0.4)]">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                    ...
                    <select
                        ...
                        className="w-full bg-[#0a0a10] border border-white/10 text-gray-200 p-3 rounded-none focus:border-neon-cyan focus:outline-none transition-colors font-body text-sm"
                    >
